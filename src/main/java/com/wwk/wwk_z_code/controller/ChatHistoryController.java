...
public class ChatHistoryController {
    ...
    public boolean remove(@Parameter(description = "记录ID", schema = @Schema(type = "String")) @PathVariable Long id) {
    ...
    public ChatHistory getInfo(
            @Parameter(description = "记录ID", schema = @Schema(type = "String"))
            @PathVariable
            Long id) {
